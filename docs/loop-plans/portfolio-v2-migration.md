...
- **Iteration 10 done:** B5 — `work/razorpay-onboarding.html` transplanted from Webflow export; password gate and hidden sidebar nav stripped.
- **Next task:** B6 — `work/meesho-vernacular.html`.
